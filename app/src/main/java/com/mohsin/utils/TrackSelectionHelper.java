...
/* package */ final public class TrackSelectionHelper implements View.OnClickListener,
  ...
  public static final TrackSelection.Factory RANDOM_FACTORY = new RandomTrackSelection.Factory();

  public final MappingTrackSelector selector;
  public final TrackSelection.Factory adaptiveVideoTrackSelectionFactory;

  public MappedTrackInfo trackInfo;
  ...
  public void setOverride(int group, int[] tracks, boolean enableRandomAdaptation) {
  ...
  public static int[] getTracksRemoving(SelectionOverride override, int removedTrack) {
